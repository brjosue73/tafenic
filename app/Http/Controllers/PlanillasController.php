  ...
  public function calculo_planilla($peticion){
    ...
    for ($i=0; $i < $tamano; $i++) { /*Recorre toda la planilla*/
      ...
      if ($converted_res=='false') { //Sino esta repetido
        ...
        if($inss_trab==0){ //sino tiene inss
          $valor_inss=0;
        }
        elseif($inss_trab!=0){ //si tiene inss
          $valor_inss=1;
        }
        ...
        elseif($inss==$valor_inss){
          $v1+=1;
        }
        elseif($valor_inss!=$inss){
          $v2+=1;
        }
        ...
        //   }
        // }
        //return $validacion_inss.' ----- ' .$inss;

        //if($validacion_inss==4){
          $identif[]=$id_trab;
